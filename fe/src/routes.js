...
// User Fit and Proper
const DataPendaftaranFitAndProper = React.lazy(() => import('./views/user/fitandproper/DataPendaftaran'))
...
const routes = [
  ...
  { path: '/fitandproper/datapendaftaran', exact: true, name: 'Data Pendaftaran Fit & Proper', element: DataPendaftaranFitAndProper },
  { path: '/fitandproper/datapendaftaran/daftar', exact: true, name: 'Pendaftaran Fit & Proper', element: PendaftaranFitAndProper },
