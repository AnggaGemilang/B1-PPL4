...
export default {
  get : () => api.get('/mappings?populate[1]=registrant&populate[2]=registrant.employee&populate[3]=position&populate[4]=registrant.employee.position&populate[5]=examiners&populate[6]=examiners.employee&populate[7]=registrant.cv&populate[8]=registrant.ppt&populate[9]=level&populate[10]=line_mappings&populate[11]=line_mappings.scores_fitproper&populate[12]=line_mappings.scores_interview&populate[13]=registrant.employee.position.grade'),
