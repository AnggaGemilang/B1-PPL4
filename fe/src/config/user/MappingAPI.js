...
export default {
  ...
  getPenguji : (registrant, position) => api.get(`/mappings?populate[1]=examiners&populate[2]=examiners.employee&populate[3]=examiners_interview.employee&filters[registrant][id][$eq]=${registrant}&filters[position][id][$eq]=${position}`).then((res) => res.data),
