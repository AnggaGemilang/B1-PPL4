    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/teams') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <div className={ this.state.teamsMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('teamsMenuOpen') } data-toggle="collapse">
              <span className="menu-icon">
                <i className="mdi mdi-laptop"></i>
              </span>
              <span className="menu-title"><Trans>Manage Teams</Trans></span>
              <i className="menu-arrow"></i>
            </div>
            <Collapse in={ this.state.teamsMenuOpen }>
              <div>
                <ul className="nav flex-column sub-menu">
                  <li className="nav-item"> <Link className={ this.isPathActive('/teams/add') ? 'nav-link active' : 'nav-link' } to="/teams/add"><Trans>Add Data</Trans></Link></li>
                  <li className="nav-item"> <Link className={ this.isPathActive('/teams/get') ? 'nav-link active' : 'nav-link' } to="/teams/get"><Trans>Get Data</Trans></Link></li>
                </ul>
              </div>
            </Collapse>
          </li>
